...
class Departmet extends Component {
    render() {
        return (
            <>
            <main>
                    ...
                    <div className="col-lg-3">
                      <ul className="nav nav-tabs flex-column">
                        <li className="nav-item">
                          <NavLink className="nav-link active show" data-bs-toggle="tab" to="/">E.N.T</NavLink>
                        </li>
                        <li className="nav-item">
                          <NavLink className="nav-link" data-bs-toggle="tab" to="/">Cancer</NavLink>
                        </li>
                        <li className="nav-item">
                          <NavLink className="nav-link" data-bs-toggle="tab" to="/">Physiotherapy</NavLink>
                        </li>
                        <li className="nav-item">
                          <NavLink className="nav-link" data-bs-toggle="tab" to="/">Dental</NavLink>
                        </li>
                        <li className="nav-item">
                          <NavLink className="nav-link" data-bs-toggle="tab" to="/">Neurosurgery</NavLink>
                        </li>
                      </ul>
                    </div>
                      ...
                      <div className="tab-content">
                        <div className="tab-pane active show" id="tab-1">
                          <div className="row">
                            ...
                            <div className="col-lg-4 text-center order-1 order-lg-2">
                              <img src={require('../assets/img/departments-1.jpg').default} alt="img" className="img-fluid" />
                            </div>
                          </div>
                        </div>
                        <div className="tab-pane" id="tab-2">
                          <div className="row">
                            ...
                            <div className="col-lg-4 text-center order-1 order-lg-2">
                              <img src={require('../assets/img/departments-2.jpg').default} alt="img" className="img-fluid" />
                            </div>
                          </div>
                        </div>
                        <div className="tab-pane" id="tab-3">
                          <div className="row">
                            ...
                            <div className="col-lg-4 text-center order-1 order-lg-2">
                              <img src={require('../assets/img/departments-3.jpg').default} alt="img" className="img-fluid" />
                            </div>
                          </div>
                        </div>
                        <div className="tab-pane" id="tab-4">
                          <div className="row">
                            ...
                            <div className="col-lg-4 text-center order-1 order-lg-2">
                              <img src={require('../assets/img/departments-4.jpg').default} alt="img" className="img-fluid" />
                            </div>
                          </div>
                        </div>
                        <div className="tab-pane" id="tab-5">
                          <div className="row">
                            ...
                            <div className="col-lg-4 text-center order-1 order-lg-2">
                              <img src={require('../assets/img/departments-5.jpg').default} alt="img" className="img-fluid" />
                            </div>
                          </div>
                        </div>
                      </div>
